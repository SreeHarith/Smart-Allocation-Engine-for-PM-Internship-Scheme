...
const MentorChat: React.FC<MentorChatProps> = ({ student }) => {
  const [messages, setMessages] = useState<Message[]>([
    { sender: 'ai', text: `Hello ${student.name.split(' ')[0]}! I'm your AI Mentor. I can help with internship recommendations, resume feedback, mock interviews, and more. How can I assist you today?` }
  ]);
  ...
  const handleSend = async (messageText?: string) => {
    ...
    const aiResponseText = await getChatbotResponse(textToSend, historyForAPI, student);
